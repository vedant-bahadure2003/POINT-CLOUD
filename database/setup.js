  ...
  try {
    ...
    const equipmentMovementQuery = `
      CREATE TABLE IF NOT EXISTS equipment_movement_details_all (
        ...
        field_data_1 LONGTEXT,
        field_data_2 LONGTEXT,
        field_data_3 LONGTEXT,
        field_data_4 LONGTEXT,
        field_data_5 LONGTEXT,
        field_data_6 LONGTEXT,
        field_data_7 LONGTEXT,
        field_data_8 LONGTEXT,
        field_data_9 LONGTEXT,
        field_data_10 LONGTEXT,
